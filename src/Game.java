...
public final class Game {
  ...
  public Game(String[] playerNames, int numSquares, int[][] snakes, int[][] ladders, int[] deathSquares) {
  ...
  public void play() {
    ...
    System.out.println("Someone alive: " + someoneAlive());
    int numRounds = 0;
    while (notOver() && someoneAlive()) {
      int roll = die.roll();
